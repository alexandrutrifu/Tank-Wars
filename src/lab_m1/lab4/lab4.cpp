...
void Lab4::RenderScene() {
    ...
    modelMatrix = glm::mat4(1);
    modelMatrix *= transform3D::Translate(sunCenterX, sunCenterY, sunCenterZ);
    modelMatrix *= transform3D::Scale(scaleX, scaleY, scaleZ);
...
void Lab4::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (window->KeyHold(GLFW_KEY_1)) {
        scaleX += deltaTime * 0.8f;
        scaleY += deltaTime * 0.8f;
        scaleZ += deltaTime * 0.8f;
    }
...
void Lab4::OnKeyPress(int key, int mods)
{
    ...
    if (key == GLFW_KEY_I) {
        miniViewportArea.y += 30;
    }

    if (key == GLFW_KEY_J) {
        miniViewportArea.x -= 30;
    }
    ...
    if (key == GLFW_KEY_U) {
        ...
        miniViewportArea.width += 30;
        miniViewportArea.height += 30;
    }
