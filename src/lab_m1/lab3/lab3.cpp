...
void Lab3::Init()
{
    ...
    Mesh* rectangle1 = object2D::CreateSquare("rectangle1", corner, squareSide / 2, glm::vec3(1, 0, 1), true);
    AddMeshToList(rectangle1);

    Mesh* rectangle2 = object2D::CreateSquare("rectangle2", corner, squareSide / 2, glm::vec3(1, 0, 1), true);
...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    // modelMatrix *= transform2D::Translate(cx, cy);
    modelMatrix *= transform2D::Scale(scaleCar1, scaleCar2);
    // modelMatrix *= transform2D::Translate(-cx, -cy);
